...
* Install `rtabmap` (1. not anaconda python 2. swtich to melodic-devel branch ).  Download the `rtabmap_ros` (melodic-devel branch does not work for me. I used the master branch.).